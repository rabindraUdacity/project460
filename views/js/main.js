...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    pixel = items[i].basicLeft + 100 * phases[i % 5] - 1250 + 'px';
    //pixel = items[i].basicLeft + 100 * phases[i % 5] - 1250;
   // items[i].style.transform = 'translate3d(' + pixel + 'px, 0,0)';
